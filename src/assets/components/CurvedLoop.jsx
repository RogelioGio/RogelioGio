...
// const pathD = `M-100,200 C400,${200 - curveAmount} 1000,${200 + curveAmount} 1540,200`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {ready && (
          <text xmlSpace="preserve" className={`fill-secondary-text ${className ?? ''} transition-all duration-500`}>
